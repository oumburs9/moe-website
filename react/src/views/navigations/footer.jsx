            ...
            <div className="py-[60px] px-0">
              <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                ...
                <div className="lg:col-span-3 md:col-span-4 mt-5">
                  ...
                  <a href="/contact-us" className="grid grid-cols-1 mt-5">
                                <button type="button" id="submitsubscribe" name="send"
                                    className="py-3 btn bg-[#2048A1] hover:bg-[#2048A1] border-[#2048A1] hover:border-[#2048A1] text-white rounded-xl shadow-lg hover:shadow-[#2048A1]">
                                    Contact Us
                                </button>
                    </a>
                </div>
...
const SocialLinks = () => {
  return (
    <ul className="list-none mt-6 flex space-x-4 items-center">
      <li className="inline hover:-translate-y-1 transition-all saturate-50 hover:saturate-100">
        ...
        >
          <img
            ...
            width="64"
            height="64"
            className="lzy lazyload--done w-7"
    ...
    <li className="inline hover:-translate-y-1 transition-all saturate-50 hover:saturate-100">
        <a href="#" target="_blank"
            ...
            <img src="https://cdn-icons-png.flaticon.com/128/5968/5968804.png"
                ...
                width="64" height="64" className="lzy lazyload--done w-7"
